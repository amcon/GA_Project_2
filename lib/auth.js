...
/* This LogIn function takes username and password results, encrypts the password,
and matches it to the databse password. If there are no errors, you will be redirected
to the home page. */
...
/* This authenticate function checks to see if there is an active session for a user. If the
session is over or if there is any other error, it will redirect to the login page. */
